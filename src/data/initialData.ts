...
export const INITIAL_ARTWORKS: Artwork[] = [
  ...
  {
    id: 'music-2',
    title: 'Elysian Pulse (M-Remix Sanctuary Edit)',
    artist: {
      id: 'artist-3',
      name: 'Kaelen Vance',
      handle: '@kaelen.vfx',
    ...
    category: 'music',
    mediaUrl: '/audio/M-Remix.mp4',
    thumbnailUrl: 'https://images.unsplash.com/photo-1470225620780-dba8ba36b745?auto=format&fit=crop&w=1200&q=80',
    medium: 'Analog Modular Synthesizer & Deep Lo-Fi Grooves',
    dimensions: 'Studio Master High-Fidelity Audio',
    year: 2026,
    description: 'Warm analog synthesizers blended with polyrhythmic low-end sub-frequencies and vinyl crackle, engineered for deep creative flow in the atelier.',
    tags: ['Music', 'Synthwave', 'Lo-Fi Soul', 'Analog Synth', 'Sound Sanctuary'],
    likesCount: 22,
    viewsCount: 240,
    savesCount: 15,
    createdAt: '2026-09-02T19:30:00Z',
    aspectRatio: 'square',
    colorPalette: ['#0f0d1a', '#e26d5c', '#382a47', '#f6e4d9', '#634b75'],
    isLiked: false,
    isSaved: false,
    featured: true,
    musicData: {
      audioUrl: '/audio/M-Remix.mp4',
      coverArtUrl: 'https://images.unsplash.com/photo-1470225620780-dba8ba36b745?auto=format&fit=crop&w=1200&q=80',
      album: 'Analog Monoliths',
      durationSeconds: 184,
      duration: '3:04',
      genre: 'Electronic Ambient / Modular Lo-Fi',
      isOriginalComposition: true,
      composer: 'Kaelen Vance',
      bpm: '96 BPM',
      key: 'F Minor',
  ...
  {
    id: 'music-3',
    title: 'Derry Solitude Theme (Orchestral Master)',
    artist: {
      id: 'artist-1',
      name: 'Julian Thorne',
      handle: '@julianthorne',
    ...
    category: 'music',
    mediaUrl: '/audio/qwTop2qs1tE.mp4',
    thumbnailUrl: 'https://images.unsplash.com/photo-1465847899084-d164df4dedc6?auto=format&fit=crop&w=1200&q=80',
    medium: 'Cinematic Orchestral Strings & Cello Solo',
    dimensions: 'Symphonic Master Recording',
    year: 2026,
    description: 'A haunting orchestral soundscape featuring weeping solo cello, muted brass, and distant thunderous timpani that mirrors the stormy atmospheric oil paintings of the Scottish highlands.',
    tags: ['Music', 'Cinematic', 'Orchestral', 'Cello Solo', 'Dark Classical'],
    likesCount: 18,
    viewsCount: 195,
    savesCount: 11,
    createdAt: '2026-09-01T14:15:00Z',
    aspectRatio: 'square',
    colorPalette: ['#101318', '#c9a875', '#242a36', '#d6dde6', '#59657a'],
    isLiked: false,
    isSaved: false,
    featured: true,
    musicData: {
      audioUrl: '/audio/qwTop2qs1tE.mp4',
      coverArtUrl: 'https://images.unsplash.com/photo-1465847899084-d164df4dedc6?auto=format&fit=crop&w=1200&q=80',
      album: 'Highland Nocturnes',
      durationSeconds: 115,
      duration: '1:55',
      genre: 'Cinematic Orchestral / Dark Ambient',
      isOriginalComposition: true,
      composer: 'Julian Thorne',
      key: 'D Minor',
      bpm: '65 BPM',
