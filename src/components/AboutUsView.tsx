...
export const AboutUsView: React.FC<AboutUsViewProps> = ({
  ...
  return (
    <div id="about-us-view" className="space-y-24 py-6 sm:py-10 max-w-6xl mx-auto px-4 sm:px-6">
      ...
      {/* ─────────────────────────────────────────────────────────────
          SECTION 2.5: ATELIER DEVELOPMENT & GITHUB CONTRIBUTIONS TABLE
         ───────────────────────────────────────────────────────────── */}
      <section id="contributions-section" className="space-y-8 scroll-mt-28">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 pb-4 border-b border-white/10">
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <span className="px-2.5 py-0.5 rounded-full text-[10px] font-mono-code font-bold uppercase tracking-[0.2em] bg-[#c9a875]/15 text-[#dfbd87] border border-[#c9a875]/30 flex items-center gap-1.5">
                <GitBranch className="w-3 h-3 text-[#c9a875]" />
                Engineering Provenance & GitHub Log
              </span>
            ...
            <h2 className="text-2xl sm:text-3xl font-serif-display font-medium text-white tracking-wide flex items-center gap-3">
              <span>Atelier Development &amp; Contributions Table</span>
            </h2>
            <p className="text-xs sm:text-sm text-neutral-400 font-sans max-w-2xl">
              Chronological log of features, design systems, and cloud architectures built on <strong className="text-neutral-200">Yesterday (Sep 6)</strong> and <strong className="text-neutral-200">Today (Sep 7)</strong> in the official GitHub repository.
            </p>
          </div>

          <a
            href="https://github.com/Afshaan-shaik/Artisan-s-Quill-"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-neutral-900/90 hover:bg-[#c9a875]/15 border border-white/15 hover:border-[#c9a875]/50 text-neutral-200 hover:text-white text-xs font-mono-code uppercase tracking-wider transition-all cursor-pointer shadow-lg hover:scale-105 active:scale-95 shrink-0"
            title="Inspect Official GitHub Repository"
          >
            <Github className="w-4 h-4 text-[#c9a875]" />
            <span>GitHub Repository</span>
            <ExternalLink className="w-3 h-3 text-neutral-400" />
          </a>
        </div>

        {/* Contributions Metrics Banner */}
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          <div className="p-3.5 rounded-xl bg-white/[0.02] border border-white/10">
            <div className="text-[10px] uppercase font-mono-code text-neutral-400">Total Milestones</div>
            <div className="text-xl font-serif-display font-bold text-white mt-1">12 Shipped</div>
            <div className="text-[11px] text-[#dfbd87] font-mono-code mt-0.5">Yesterday &amp; Today</div>
          </div>
          <div className="p-3.5 rounded-xl bg-white/[0.02] border border-white/10">
            <div className="text-[10px] uppercase font-mono-code text-neutral-400">Modules Built</div>
            <div className="text-xl font-serif-display font-bold text-white mt-1">2,195 Modules</div>
            <div className="text-[11px] text-emerald-400 font-mono-code mt-0.5">0 Type Errors</div>
          </div>
          <div className="p-3.5 rounded-xl bg-white/[0.02] border border-white/10">
            <div className="text-[10px] uppercase font-mono-code text-neutral-400">Database Integrity</div>
            <div className="text-xl font-serif-display font-bold text-white mt-1">Zero Data Loss</div>
            <div className="text-[11px] text-[#dfbd87] font-mono-code mt-0.5">Supabase + Firebase</div>
          </div>
          <div className="p-3.5 rounded-xl bg-white/[0.02] border border-white/10">
            <div className="text-[10px] uppercase font-mono-code text-neutral-400">Vercel Status</div>
            <div className="text-xl font-serif-display font-bold text-emerald-400 mt-1">Live &amp; Aliased</div>
            <div className="text-[11px] text-neutral-400 font-mono-code mt-0.5">Production Ready</div>
          </div>
        </div>

        {/* Contributions Interactive Table */}
        <div className="overflow-hidden rounded-2xl border border-white/10 bg-[#090b10]/95 shadow-2xl backdrop-blur-xl">
          <div className="overflow-x-auto">
            <table className="w-full text-left text-xs font-sans border-collapse">
              <thead>
                <tr className="border-b border-white/10 bg-white/[0.03] text-[11px] font-mono-code text-[#dfbd87] uppercase tracking-wider">
                  <th className="py-3.5 px-4 font-semibold">Date</th>
                  <th className="py-3.5 px-4 font-semibold">Milestone / Feature</th>
                  <th className="py-3.5 px-4 font-semibold">Category</th>
                  <th className="py-3.5 px-4 font-semibold hidden md:table-cell">Impacted Files</th>
                  <th className="py-3.5 px-4 font-semibold hidden lg:table-cell">Architectural Impact</th>
              ...
              <tbody className="divide-y divide-white/5 font-sans">
                ...
                <tr className="hover:bg-white/[0.02] transition-colors group">
                  <td className="py-3.5 px-4 font-mono-code whitespace-nowrap">
                    <span className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-md bg-[#c9a875]/20 text-[#dfbd87] border border-[#c9a875]/40 font-bold">
                      <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse" />
                      Sep 7 (Today)
                    </span>
                  </td>
                  <td className="py-3.5 px-4">
                    <div className="font-semibold text-white group-hover:text-[#dfbd87] transition-colors">
                      Vercel Production Deployment
                    </div>
                    <div className="text-[11px] text-neutral-400 mt-0.5">
                      Live deployment with custom alias and instant edge invalidation
                    </div>
                  </td>
                  <td className="py-3.5 px-4">
                    <span className="px-2 py-0.5 rounded bg-blue-500/10 text-blue-300 border border-blue-500/20 font-mono-code text-[10px]">
                      DevOps / Vercel
                    </span>
                  </td>
                  <td className="py-3.5 px-4 font-mono-code text-neutral-400 text-[11px] hidden md:table-cell">
                    .vercel/, dist/
                  </td>
                  <td className="py-3.5 px-4 text-neutral-300 text-[11px] hidden lg:table-cell">
                    Aliased to the-artisans-quill-digital-art-poet.vercel.app with zero edge caching
                  </td>
                  <td className="py-3.5 px-4 text-right">
                    <span className="inline-flex items-center gap-1 text-[11px] text-emerald-400 font-mono-code">
                ...
                <tr className="hover:bg-white/[0.02] transition-colors group">
                  ...
                  <td className="py-3.5 px-4">
                    <div className="font-semibold text-white group-hover:text-[#dfbd87] transition-colors">
                      Sanctuary State &amp; View Switcher Integration
                    </div>
                    <div className="text-[11px] text-neutral-400 mt-0.5">
                      Connected PoetrySanctuaryView and CustomPoemModal to main App loop
                    </div>
                  </td>
                  <td className="py-3.5 px-4">
                  ...
                  <td className="py-3.5 px-4 text-neutral-300 text-[11px] hidden lg:table-cell">
                    Intercepts poetry category to show immersive parchment reader instead of generic grid
                  </td>
                  <td className="py-3.5 px-4 text-right">
                    <span className="inline-flex items-center gap-1 text-[11px] text-emerald-400 font-mono-code">
                      <CheckCircle2 className="w-3.5 h-3.5" />
                ...
                <tr className="hover:bg-white/[0.02] transition-colors group">
                  ...
                  <td className="py-3.5 px-4">
                    <div className="font-semibold text-white group-hover:text-[#dfbd87] transition-colors">
                      Universal Poem CRUD &amp; Cloud Sync
                    </div>
                    <div className="text-[11px] text-neutral-400 mt-0.5">
                      Full write, edit, delete capabilities with live WebSocket broadcasting
                    </div>
                  </td>
                  <td className="py-3.5 px-4">
                    <span className="px-2 py-0.5 rounded bg-amber-500/10 text-amber-300 border border-amber-500/20 font-mono-code text-[10px]">
                      Cloud &amp; Sync
                    </span>
                  </td>
                  <td className="py-3.5 px-4 font-mono-code text-neutral-400 text-[11px] hidden md:table-cell">
                  ...
                  <td className="py-3.5 px-4 text-neutral-300 text-[11px] hidden lg:table-cell">
                    Non-destructive merge into Supabase and Firebase with real-time feedback toasts
                  </td>
                  <td className="py-3.5 px-4 text-right">
                    <span className="inline-flex items-center gap-1 text-[11px] text-emerald-400 font-mono-code">
                      <CheckCircle2 className="w-3.5 h-3.5" />
                ...
                {/* ── YESTERDAY (SEP 6, 2026) ── */}
                <tr className="hover:bg-white/[0.02] transition-colors group">
                  <td className="py-3.5 px-4 font-mono-code whitespace-nowrap">
                    <span className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-md bg-white/5 text-neutral-300 border border-white/10 font-bold">
                      Sep 6 (Yesterday)
                    </span>
                  </td>
                  <td className="py-3.5 px-4">
                    <div className="font-semibold text-white group-hover:text-[#dfbd87] transition-colors">
                      PoetrySanctuaryView Component
                    </div>
                    <div className="text-[11px] text-neutral-400 mt-0.5">
                      3 layout modes: 📚 Shelf, 🖊 Desk, and ⊞ Grid + full-screen reader overlay
                    </div>
                  </td>
                  <td className="py-3.5 px-4">
                    <span className="px-2 py-0.5 rounded bg-rose-500/10 text-rose-300 border border-rose-500/20 font-mono-code text-[10px]">
                      Frontend / View
                    </span>
                  </td>
                  <td className="py-3.5 px-4 font-mono-code text-neutral-400 text-[11px] hidden md:table-cell">
                    src/components/PoetrySanctuaryView.tsx
                  </td>
                  <td className="py-3.5 px-4 text-neutral-300 text-[11px] hidden lg:table-cell">
                    Standing parchment shelf physics, desk cards, bookmark ribbon close tab
                  </td>
                  <td className="py-3.5 px-4 text-right">
                    <span className="inline-flex items-center gap-1 text-[11px] text-emerald-400 font-mono-code">
                      <CheckCircle2 className="w-3.5 h-3.5" />
                ...
                <tr className="hover:bg-white/[0.02] transition-colors group">
                  ...
                  <td className="py-3.5 px-4">
                    <div className="font-semibold text-white group-hover:text-[#dfbd87] transition-colors">
                      CustomPoemModal Writing &amp; Editing Suite
                    </div>
                    <div className="text-[11px] text-neutral-400 mt-0.5">
                      Live parchment preview with stain variants, 5 paper tones, and dedication field
                    </div>
                  </td>
                  <td className="py-3.5 px-4">
                    <span className="px-2 py-0.5 rounded bg-emerald-500/10 text-emerald-300 border border-emerald-500/20 font-mono-code text-[10px]">
                      Interactive Modal
                    </span>
                  </td>
                  <td className="py-3.5 px-4 font-mono-code text-neutral-400 text-[11px] hidden md:table-cell">
                    src/components/CustomPoemModal.tsx
                  </td>
                  <td className="py-3.5 px-4 text-neutral-300 text-[11px] hidden lg:table-cell">
                    WYSIWYG split preview on tea/coffee backgrounds with instantaneous rendering
                  </td>
                  <td className="py-3.5 px-4 text-right">
                    <span className="inline-flex items-center gap-1 text-[11px] text-emerald-400 font-mono-code">
                      <CheckCircle2 className="w-3.5 h-3.5" />
                ...
                <tr className="hover:bg-white/[0.02] transition-colors group">
                  ...
                  <td className="py-3.5 px-4">
                    <div className="font-semibold text-white group-hover:text-[#dfbd87] transition-colors">
                      Authorship Provenance &amp; Deletion Guards
                    </div>
                    <div className="text-[11px] text-neutral-400 mt-0.5">
                      Session-bound client ownership tracking with permanent masterwork protection
                    </div>
                  </td>
                  <td className="py-3.5 px-4">
                    <span className="px-2 py-0.5 rounded bg-cyan-500/10 text-cyan-300 border border-cyan-500/20 font-mono-code text-[10px]">
                      Security / Auth
                    </span>
                  </td>
                  <td className="py-3.5 px-4 font-mono-code text-neutral-400 text-[11px] hidden md:table-cell">
                  ...
                  <td className="py-3.5 px-4 text-neutral-300 text-[11px] hidden lg:table-cell">
                    Enforces canUserManageArtwork for guest creators while protecting curatorial poems
                  </td>
                  <td className="py-3.5 px-4 text-right">
                    <span className="inline-flex items-center gap-1 text-[11px] text-emerald-400 font-mono-code">
                      <CheckCircle2 className="w-3.5 h-3.5" />
                ...
                <tr className="hover:bg-white/[0.02] transition-colors group">
                  ...
                  <td className="py-3.5 px-4">
                    <div className="font-semibold text-white group-hover:text-[#dfbd87] transition-colors">
                      3 Founding Curatorial Coffee Poems
                    </div>
                    <div className="text-[11px] text-neutral-400 mt-0.5">
                      Late Kettle (I.), Marginalia (II.), and Second Cup (III.) indexed permanently
                    </div>
                  </td>
                  <td className="py-3.5 px-4">
                    <span className="px-2 py-0.5 rounded bg-yellow-500/10 text-yellow-300 border border-yellow-500/20 font-mono-code text-[10px]">
                      Curatorial Archive
                    </span>
                  </td>
                  <td className="py-3.5 px-4 font-mono-code text-neutral-400 text-[11px] hidden md:table-cell">
                  ...
                  <td className="py-3.5 px-4 text-neutral-300 text-[11px] hidden lg:table-cell">
                    Complete multi-stanza text with Roman numerals, dedications, and coffee stain variants
                  </td>
                  <td className="py-3.5 px-4 text-right">
                    <span className="inline-flex items-center gap-1 text-[11px] text-emerald-400 font-mono-code">
                      <CheckCircle2 className="w-3.5 h-3.5" />
                ...
                <tr className="hover:bg-white/[0.02] transition-colors group">
                  ...
                  <td className="py-3.5 px-4">
                    <div className="font-semibold text-white group-hover:text-[#dfbd87] transition-colors">
                      Classical IM Fell English &amp; Parchment CSS Suite
                    </div>
                    <div className="text-[11px] text-neutral-400 mt-0.5">
                      17th-century editorial typography, deckle torn edges, and coffee ring radial halos
                    </div>
                  </td>
                  <td className="py-3.5 px-4">
                    <span className="px-2 py-0.5 rounded bg-indigo-500/10 text-indigo-300 border border-indigo-500/20 font-mono-code text-[10px]">
                      Typography &amp; CSS
                    </span>
                  </td>
                  <td className="py-3.5 px-4 font-mono-code text-neutral-400 text-[11px] hidden md:table-cell">
                  ...
                  <td className="py-3.5 px-4 text-neutral-300 text-[11px] hidden lg:table-cell">
                    Added Google Font IM Fell English + 12 custom utilities (.torn-card-deckle, .coffee-ring)
                  </td>
                  <td className="py-3.5 px-4 text-right">
                    <span className="inline-flex items-center gap-1 text-[11px] text-emerald-400 font-mono-code">
                      <CheckCircle2 className="w-3.5 h-3.5" />
          ...
          <div className="px-6 py-4 bg-white/[0.01] border-t border-white/5 flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-[11px] font-mono-code text-neutral-400">
            <div className="flex items-center gap-2">
              <GitCommit className="w-3.5 h-3.5 text-[#c9a875]" />
              <span>Full commit logs &amp; architectural changelogs mirrored to GitHub</span>
            </div>
            <a
              href="https://github.com/Afshaan-shaik/Artisan-s-Quill-/commits/main"
              target="_blank"
              rel="noopener noreferrer"
              className="text-[#dfbd87] hover:text-white transition-colors flex items-center gap-1.5"
            >
              <span>View GitHub Commit History</span>
